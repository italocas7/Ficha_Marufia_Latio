...
O rótulo **Alpha** descreve o canal atual e não é acrescentado ao número `0.3.0`. Assim, o instalador conserva um número aceito pelo empacotamento Windows enquanto a interface comunica claramente que o produto ainda está em desenvolvimento.

...
O produto adota [Semantic Versioning](https://semver.org/lang/pt-BR/) e está na versão **0.2.0**, com a identidade visível **Marufia Online Alpha**. O número canônico fica em `package.json` e precisa coincidir com Tauri, Cargo, o manifesto de atualização e a informação exibida no aplicativo.
...
O rótulo **Alpha** descreve o canal atual e não é acrescentado ao número `0.2.0`. Assim, o instalador conserva um número aceito pelo empacotamento Windows enquanto a interface comunica claramente que o produto ainda está em desenvolvimento.

# GitHub Releases — Fase 48

A primeira entrega é um **pré-lançamento** com estes dados:

- tag: `v0.1.0`;
- título: **Marufia Online Alpha 0.1.0**;
- notas: `docs/releases/v0.1.0.md`;
...
A tag e os arquivos só devem ser enviados ao repositório remoto depois de autorização explícita e autenticação do GitHub. Nunca inclua token, senha, chave privada ou certificado nas notas, no Git ou nos artefatos.
